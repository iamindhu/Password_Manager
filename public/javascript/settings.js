...
var n_username=null,n_email=null,n_number=null;

confirm_button.addEventListener("click",()=>{
   update(n_username,n_email,n_number);
...
async function update(n_username,n_email,n_number){
  if(n_username==null&&n_email==null&&n_number==null){
    error.innerHTML="details not entered";
  }
  else{
